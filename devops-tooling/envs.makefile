...
local-awscdk%: export TFSTACK_NAME=LambdaDDB-$(STACK_SUFFIX)
...
integ-awscdk-vpc%: export TFSTACK_NAME=LambdaDDBVpc-$(STACK_SUFFIX)
...
sbx-awscdk%: export TFSTACK_NAME=LambdaDDB-$(STACK_SUFFIX)
sbx-awscdk-vpc%: export TFSTACK_NAME=LambdaDDBVpc-$(STACK_SUFFIX)
